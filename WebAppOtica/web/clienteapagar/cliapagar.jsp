    ...
    <div class="container py-5">
        <div class="card shadow-lg">
            <div class="card-header bg-danger text-white text-center">
                <h2 class="mb-0">
                    <i class="fas fa-trash-alt me-2"></i>Controle de Clientes - Apagar
                </h2>
            </div>
            <div class="card-body">
                <%
                ...
                %>
                    <div class="alert alert-success" role="alert">
                        <i class="fas fa-check-circle me-2"></i>Cliente excluído com sucesso!!!
                    </div>
                <% } else { %>
                    <div class="alert alert-danger" role="alert">
                        <i class="fas fa-exclamation-triangle me-2"></i>Cliente não encontrado ou não pôde ser excluído!
                    </div>
                <% } 
